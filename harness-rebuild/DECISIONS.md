...
| ID                                                         | 决策                           | 状态     |
| ---------------------------------------------------------- | ------------------------------ | -------- |
| [ADR-001](decisions/ADR-001-仅旗舰原生工具不降级.md)       | 仅云端旗舰原生工具；禁止降级   | accepted |
| [ADR-002](decisions/ADR-002-结果与原因两轴终态.md)         | 终态采用结果×原因两轴          | accepted |
| [ADR-003](decisions/ADR-003-partial与协议错误分界.md)      | partial 与 protocol_error 分界 | accepted |
| [ADR-004](decisions/ADR-004-引用资格与sources-only边界.md) | 引用资格与 sources-only 边界   | accepted |
